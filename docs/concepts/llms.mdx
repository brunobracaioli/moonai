---
title: LLMs
description: Learn how to configure and optimize LLMs for your Moonai projects.
icon: microchip-ai
---

# Large Language Models (LLMs) in Moonai

Large Language Models (LLMs) are the backbone of intelligent agents in the Moonai framework. This guide will help you understand, configure, and optimize LLM usage for your Moonai projects.

## Key Concepts

- **LLM**: Large Language Model, the AI powering agent intelligence
- **Agent**: A Moonai entity that uses an LLM to perform missions
...
Moonai offers flexible options for setting up LLMs:

### 1. Default Configuration

By default, Moonai uses the `gpt-4o-mini` model. It uses environment variables if no LLM is specified:
...
<AccordionGroup>
    ...
    Moonai supports using Ollama for running open-source models locally:
...
4. **Use appropriate temperature**: Lower for factual missions, higher for creative ones.
