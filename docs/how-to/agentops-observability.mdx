...
<CardGroup cols={3}>
  ...
  <Card
    ...
    color="#F3A78B"
    href="https://github.com/brunobracaioli/moonai-examples/tree/main/markdown_validator"
    icon="markdown"
      iconType="solid"
    >
    ...
    color="#F3A78B"
    href="https://github.com/brunobracaioli/moonai-examples/tree/main/instagram_post"
