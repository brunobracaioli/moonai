...
[Spider](https://spider.cloud/?ref=moonai) is the [fastest](https://github.com/spider-rs/spider/blob/main/benches/BENCHMARKS.md#benchmark-results) 
...
and the `moonai.moonai_tools` SDK too:
